...
const bakingTime = function bakingTime(){
  return 50
}
...
const remainingBakeTime = function remainingBakeTime(inOven){
...
const calculatePreparationTime = function calculatePreparationTime(layers){
  return layers * 3
}
...
const totalTimeSpent = function totalTimeSpent(layers, inOven){
